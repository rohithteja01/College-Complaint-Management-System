...
export default function ComplaintDetailsPage() {
  ...
  const handleDeleteComplaint = async () => {
    ...
    try {
      ...
      navigate(currentUser?.role === 'admin' ? '/admin/complaints' : '/student/dashboard', {
  ...
  const handleSubmitFeedback = async (e) => {
    ...
    try {
      const targetId = complaint._id || complaint.complaintId;
    ...
    return (
      <div className="min-h-[calc(100vh-4rem)] bg-slate-50 py-12 px-4 flex items-center justify-center">
        <div className="bg-white p-8 rounded-xl border border-slate-200 text-center shadow-2xs space-y-4 max-w-md">
          ...
          <Link
            to={currentUser?.role === 'admin' ? '/admin/complaints' : '/student/dashboard'}
  ...
  const isOwner = currentUser && complaint.student && (
    (typeof complaint.student === 'object' && (complaint.student._id === currentUser.id || complaint.student.id === currentUser.id)) ||
    ...
    <div className="min-h-[calc(100vh-4rem)] bg-slate-50 py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <Link
            to={isAdmin ? '/admin/complaints' : '/student/dashboard'}
